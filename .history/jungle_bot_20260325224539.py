...
def rewrite_article_with_ai(raw_text):
    ...
    5. Write a catchy 'title' and a punchy 'excerpt' (THE EXCERPT MUST BE STRICTLY UNDER 250 CHARACTERS).    6. Provide a SINGLE, simple visual search keyword to find a stock photo for this story (e.g., "police", "university", "technology", "soccer"). Name the key 'image_keywords'.
...
def run_bot():
    ...
    for entry in feed.entries[:2]:
        ...
        # Safely grab the excerpt and force it to be under 295 characters for your database
        ...
        payload = {
            ...
            "excerpt": safe_excerpt,  # <--- Using the safe, truncated excerpt here
