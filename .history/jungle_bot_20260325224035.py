...
PEXELS_API_KEY = "import requests
import feedparser
from newspaper import Article as NewsScraper
from google import genai
from google.genai import types
...
JUNGLE_BOT_KEY = "jungle_super_secret_bot_key_2026"  
GEMINI_API_KEY = "AIzaSyCE2zLpEmTtI5We3R6R2mAevuDsgGkW2KQ" 
PEXELS_API_KEY = "PASTE_YOUR_FREE_PEXELS_KEY_HERE" # <--- NEW!
...
def rewrite_article_with_ai(raw_text):
    ...
    4. Provide a SINGLE, simple visual search keyword to find a stock photo for this story (e.g., "police", "university", "technology", "soccer"). Name the key 'image_keywords'.
